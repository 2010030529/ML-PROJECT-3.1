...
@app.route('/')
def login():
    face_classifier=cv2.CascadeClassifier(r'C:\Users\saiva\PycharmProjects\pythonProject\Face expression detection\haarcascade_frontalface_default.xml')
    classifier=load_model('emotionexpressiondata.h5')
    #assign
